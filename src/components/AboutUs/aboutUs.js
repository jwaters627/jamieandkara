      ...
      <div className='aboutUsContainer'>
        ...
        <div className='mainContainer'>
          ...
          <div className='infoContainer'>
            ...
            <h4>Getting There:</h4>
            <p>We encourage you to walk or take a taxi/Uber to the venue, but there is parking available if you need it. There is a parking lot adjacent to Ocean Gateway, and there is the Ocean Gateway Garage is just a few hundred feet from the venue.</p>
            <h4>Garage:</h4>
