    ...
    return(
      <div className={drawerClass}>
        <ul className='navDrawerList'>
          ...
          <li onClick={this.props.showDrawer} className={linkOne}><NavLink className='navLink' to="/">HOME</NavLink></li>
          <li onClick={this.props.showDrawer} className={linkTwo}><NavLink className='navLink' to="/about_us">ABOUT US</NavLink></li>
          <li onClick={this.props.showDrawer} className={linkThree}><NavLink className='navLink' to="/wedding_party">WEDDING PARTY</NavLink></li>
          <li onClick={this.props.showDrawer} className={linkFour}><NavLink className='navLink' to="/weekend_events">WEEKEND EVENTS</NavLink></li>
